      ...
      >
        ...
        <div className="card bg-gradient-to-br from-teal-light/10 to-pink-light/10 mb-8">
          <div className="flex flex-col md:flex-row items-center">
            <div className="flex-1 text-center md:text-left mb-6 md:mb-0">
              ...
              <button
                onClick={() => navigate('/dashboard/healers')}
        ...
        <div className="card mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { title: 'Ayurveda Doctors', desc: 'Traditional healing expertise', path: '/dashboard/chat' },
              { title: 'Yoga Experts', desc: 'Personalized practice plans', path: '/dashboard/resources' },
              { title: 'Counselors', desc: 'Mental wellness support', path: '/dashboard/resources' },
              { title: 'Functional Movement Trainers', desc: 'Movement optimization & rehabilitation', path: '/dashboard/resources' }
            ].map((category, index) => (
              <button
                key={index}
                onClick={() => navigate(category.path)}
                className="flex items-center p-4 rounded-lg border-2 border-gray-100 hover:border-teal hover:bg-teal-light/10 transition-all w-full text-left"
              >
